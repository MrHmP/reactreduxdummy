...
class RepoDetails extends React.Component{
    ...
    onRepoClicked(e){
        ...
        if(!this.props.courses.find(o => o.title===courseToAdd.title))
        {
            ...
            toast.success(`${courseToAdd.title} added to course`);
        }else{
            this.props.removeRepoFromCourse(courseToAdd);
            toast.error(`${courseToAdd.title} removed to course`);
        }
    }
            ...
            <tr>
                ...
                <td>
                    <button type="button" className="btn btn-small disable">
                        ...
                        <span className="badge badge-light">{repoInfo.stargazers_count}</span>
                    </button>
                    {/* <button type="button" className="btn btn-small disable">
                    ...
                    <svg aria-hidden="true" className="octicon octicon-repo-forked" height="16" version="1.1" viewBox="0 0 10 16" width="10"><path fill-rule="evenodd" d="M8 1a1.993 1.993 0 0 0-1 3.72V6L5 8 3 6V4.72A1.993 1.993 0 0 0 2 1a1.993 1.993 0 0 0-1 3.72V6.5l3 3v1.78A1.993 1.993 0 0 0 5 15a1.993 1.993 0 0 0 1-3.72V9.5l3-3V4.72A1.993 1.993 0 0 0 8 1zM2 4.2C1.34 4.2.8 3.65.8 3c0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3 10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2zm3-10c-.66 0-1.2-.55-1.2-1.2 0-.65.55-1.2 1.2-1.2.65 0 1.2.55 1.2 1.2 0 .65-.55 1.2-1.2 1.2z"></path></svg>
                        <span className="badge badge-light">{repoInfo.forks_count}</span>
                    </button>
                </td>
                ...
                <td><button className={repoAdded ? 'btn btn-danger': 'btn btn-success'}  onClick={this.onRepoClicked} >{repoAdded ? 'Remove Repo from Course' : 'Add Repo to Course'}</button></td>
            </tr>
        );
    }
}
